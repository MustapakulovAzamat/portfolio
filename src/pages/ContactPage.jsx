...
export const ContactPage = () => {
  ...
  return (
    <div id='contact' className='w-full min-h-[65vh] flex items-center'>
      <div className="container">
        ...
        <div>
          <form ref={form} onSubmit={sendEmail} className='flex flex-col justify-center items-center gap-4'>
            <input type="text" name='user_name' placeholder='Your name' required className='
              p-3 border-2 border-[rgb(26,31,35)] rounded-2xl
            '/>
            <input type="email" name='user_email' placeholder='Your email' required className='
              p-3 border-2 border-[rgb(26,31,35)] rounded-2xl
            '/>
